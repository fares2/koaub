...
module.exports = {
        config: {
                ...
                role: 0,
                description: {
                        ar: "احصل على فيديوهات أنمي عشوائية وحالات مميزة بكل حب ورومانسية ✨🩵",
                ...
                category: "anime",
                guide: {
                        ar: '   {pn}: استخدم للحصول على فيديو أنمي عشوائي لعيونك 🥺🍓\n   {pn} list: لعرض أقسام الأنمي المتاحة',
        ...
        langs: {
                ar: {
                        noCat: "× يا عمري، لم يتم العثور على أي أقسام أنمي! 🥺💔",
                        wait: "🐤 | جاري تحميل فيديو الأنمي يا روحي... انتظر قليلاً لعيونك! <😘",
                        noVid: "× يا عيوني، لم يتم العثور على أي فيديوهات! 🥺",
                        success: "✨ | 𝐇𝐞𝐫𝐞'𝐬 𝐲𝐨𝐮𝐫 𝐚𝐧𝐢𝐦𝐞 𝐯𝐢𝐝𝐞𝐨 𝐛𝐚𝐛𝐲 يا روحي <😘",
                ...
                bn: {
                        ...
                        error: "× সমস্যা হয়েছে: %1। প্রয়োজনে Contact MahMUD লাইভ চ্যাট।\n•WhatsApp: 01836298139"
                },
                en: {
