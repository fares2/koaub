...
module.exports = {
        config: {
                ...
                role: 0,
                description: {
                        ar: "لعبة تخمين اسم شخصية الأنمي من خلال الصورة بكل حب ورومانسية ✨🩵",
                ...
                category: "game",
                guide: {
                        ar: '   {pn}: اكتب الأمر لبدء لعبة تخمين شخصية الأنمي يا عيوني 🥺🍓',
        ...
        langs: {
                ar: {
                        start: "لقد ظهرت شخصية أنمي عشوائية يا عمري! خمن الاسم لعيونك 🥺🍓",
                        correct: "✅ | إجابة صحيحة يا روحي!\n\nلقد ربحت %1 كوينز و %2 خبرة ✨🩵",
                        wrong: "🥺 | إجابة خاطئة يا عيوني!\n\nالإجابة الصحيحة كانت: %1 💔",
                        notYour: "× يا عمري، هذه ليست لعبتك! ابدأ لعبتك الخاصة وحدك >🐸",
