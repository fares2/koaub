...
module.exports = {
        config: {
                ...
                role: 0,
                description: {
                        ar: "صمم تأثير إعلان مميز باستخدام صورة شخص ما بكل حب ✨🩵",
                ...
                category: "fun",
                guide: {
                        ar: '   {pn} <@tag>: قم بالإشارة إلى شخص لتطبيق إعلان لعيونه 🥺🍓\n   {pn} <uid>: إنشاء تأثير باستخدام المعرف UID\n   (أو استخدم الأمر بالرد على رسالة شخص ما)',
        ...
        langs: {
                ar: {
                        noTarget: "× يا عمري، يرجى الإشارة إلى شخص، الرد على رسالته، أو كتابة المعرف UID الخاص به! 📺🥺",
                        success: "تم إنشاء تأثير الإعلان بنجاح يا روحي ✨🩵",
                        error: "حدث خطا يرجى تواصل معا مطور Fares لتصليح هذا الامر رقم واتساب 0793229194 ✨🩵"
                },
                bn: {
