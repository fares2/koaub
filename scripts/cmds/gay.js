...
module.exports = {
        config: {
                ...
                role: 0,
                description: {
                        ar: "أضف تأثير الفخر أو المؤثرات المرحة على أي شخص بكل حب ورومانسية ✨🩵",
                ...
                category: "fun",
                guide: {
                        ar: '   {pn} <@منشن>: قم بالإشارة إلى شخص أو الرد على رسالته أو ضع الـ UID لعيونك 🥺🍓',
        ...
        langs: {
                ar: {
                        noTarget: "• يا روحي، لازم تمنشن شخص، ترد على رسالته، ولا تحط الـ UID تاعو باش نخدمها لعيونك 🥺🍓",
                        success: "✨ | تفضل يا عيوني، هاذي هي النتيجة تاع التأثير لعيونك 🩵",
                        error: "× يا حياتي، صرا مشكل فالتأثير: %1. تواصل مع MahMUD يعاونك 🥺💔"
                },
                bn: {
